...
const Header = () => {
  ...
  <div className="flex justify-end text-[12px] items-center h-6.25 px-16">
    <span className="px-4 cursor-pointer hover:text-[#FFE1D2]">SAVE MORE ON APP</span>
    <span className="px-4 cursor-pointer hover:text-[#FFE1D2]">SELL ON DARAZ</span>
    <span className="px-4 cursor-pointer hover:text-[#FFE1D2]">HELP & SUPPORT</span>
    <span className="px-4 cursor-pointer hover:text-[#FFE1D2]">LOGIN</span>
